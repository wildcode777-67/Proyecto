<?php
// Traemos la conexión ($pdo) desde la capa de datos
require_once "datos/conexion.php";

// Consulta de prueba pedida por la letra: un SELECT real que
// muestre datos desde la base hacia una pantalla del prototipo.
// Usamos JOIN para traer el nombre de la categoría en vez de solo su id.
